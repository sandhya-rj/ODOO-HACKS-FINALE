...
-- CreateEnum
CREATE TYPE "CourseAccessRule" AS ENUM ('OPEN', 'INVITE', 'PAID');
...
-- CreateEnum
CREATE TYPE "PointSourceType" AS ENUM ('QUIZ', 'COURSE');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('LESSON_START', 'LESSON_COMPLETE', 'QUIZ_ATTEMPT');
...
CREATE TABLE "Course" (
    ...
    "accessRule" "CourseAccessRule" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Course" ADD CONSTRAINT "Course_courseAdminId_fkey" FOREIGN KEY ("courseAdminId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
